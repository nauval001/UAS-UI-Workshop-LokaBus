            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-2xl border border-gray-100 p-6 sm:p-8">
                ...
                <form action="{{ route('admin.buses.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm" placeholder="Contoh: LokaBus Trans Jawa" required>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="facilities" id="facilities" rows="3" class="w-full border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg shadow-sm" placeholder="Contoh: AC, Toilet, Reclining Seat, USB Charger">{{ old('facilities') }}</textarea>
